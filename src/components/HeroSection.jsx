...
const HeroSection = () => {
  return (
    <section className="lg:py-16 lg:px-16">
      <div className="grid grid-cols-1 sm:grid-cols-12 py-20 md:py-16">
        <motion.div
          initial={{ opacity: 0, scale: 0.5 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5 }}
          className="col-span-8 place-self-center text-center sm:text-left justify-self-center md:justify-self-start"
        >
        ...
        >
          <div className="w-[300px] h-[300px] rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[400px] lg:h-[400px] relative">
            <img
              src="/images/projects/homeprofileimg.jpeg"
              alt="hero image"
